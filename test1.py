...
actions = {
    # 攻撃・防御・賢さを上げる特訓
    1: [1, 85, 0, 2, 1, 0],    # 初級の攻撃特化、成功しやすいが効果は控えめ
    ...
    8: [2, 45, 0, 0, 4, 4],    # 上級の防御・賢さ特化、失敗しやすいが効果大
    9: [2, 55, 0, 4, 0, 5],    # 上級の攻撃・賢さ特化、バランスが良い
    ...
    # 体力を回復させるアクション
    16: [0, 90, 3, 0, 0, 0],  # 簡単な休息、体力を少し回復
    17: [0, 60, 5, 0, 0, 0],   # 体力回復メインの休憩、しっかりと休む
    18: [0, 30, 8, 0, 0, 0],   # がっつりとした休憩、リスクはあるが体力を大幅回復
