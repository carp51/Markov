...
# 特定の行動パスを指定する
actions_sequence = [[[], [8]] + [[8, 11]] * 9,
                    [[], [7]] + [[7, 11]] * 9,
                    [[], [4, 10], [6, 10], [4, 10], [6, 10], [4, 10], [6, 10], [4, 10], [6, 10], [4, 10], [6, 10]],
                    [7, 6, 17, 7, 6, 17, 7, 6, 17, 7],
                    [19, 7, 6, 17, 7, 6, 17, 7, 6, 17],
                    [7, 6, 17, 19, 7, 6, 17, 19, 7, 6,],
                    [18, 18, 18, 18, 18, 18, 18, 18, 18, 18]]

actions_sequence_index = 2
...
# print(states[8][(parameters['M_HP_max'], 5, 6, 6, 0, 0)])
# print(policies[8][(parameters['M_HP_max'], 5, 6, 6, 0, 0)])